	...
	render(){
		...
		return (
				...
				<Row>
					<Carousel>
					    <Carousel.Item>
					      <img width={800} height={100} alt="500x300" src="/images/home3.jpg"/>
					      <Carousel.Caption>
					    ...
					    <Carousel.Item>
					      <img width={800} height={100} alt="500x300" src="/images/home2.jpg"/>
					      <Carousel.Caption>
					        <h3 style = {{color:'blue'}}>Wishlist</h3>
					        <p style = {{color:'blue'}} >Books on this page are on your wishlist and ready to be added to your Personal Library</p>
					      </Carousel.Caption>
					    </Carousel.Item>
					</Carousel>
				</Row>
